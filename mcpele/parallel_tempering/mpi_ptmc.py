...
class MPI_PT_RLhandshake(_MPI_Parallel_Tempering):
    ...
    def _all_print_status(self):
        ...
        status.frac_acc_swaps = float(self.swap_accepted_count) / (
