...
class _MPI_Parallel_Tempering(object):
    ...
    def __init__(self, mcrunner, Tmax, Tmin, max_ptiter, pfreq=1, skip=0, print_status=True,
                 base_directory=None, swap=True, verbose=False):
    ...
    def _scatter_data(self, in_send_array, adim, dtype='d'):
        ...
        recv_array = np.empty(int(adim/self.nproc),dtype=dtype)
