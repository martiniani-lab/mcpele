...
void TakeStepProbabilities::add_step(std::shared_ptr<TakeStep> step_input,
                                     const double weight_input) {
...
void TakeStepProbabilities::report(pele::Array<double> &old_coords,
