...
/*GaussianTakeStep is a base class from which all the gaussian based take step
 * routines should derive as it implements all its basic components
 * */
class GaussianTakeStep : public TakeStep {
 protected:
  ...
  /*draw ndim random variates from N(0,1) and fill up the m_normal_vec array
   * with them*/
